// One labelled slider in the controls row. Copied per-experiment on purpose —
// see docs/DESIGN.md (don't abstract a shared control until it earns it).

interface RangeControlProps {
  label: string;
  /** Value rendered next to the label, already formatted (e.g. "4px"). */
  valueText: string;
  value: number;
  min: number;
  max: number;
